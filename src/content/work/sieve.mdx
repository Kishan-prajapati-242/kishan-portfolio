...
summary: Hybrid retrieval and deduplication over 182,853 papers on an 8 GB fanless laptop, at no infrastructure cost. Postgres with pgvector and HNSW, and bge-small embeddings on CPU.
stack:
  - Python 3.12
  - FastAPI
  - PostgreSQL 16
